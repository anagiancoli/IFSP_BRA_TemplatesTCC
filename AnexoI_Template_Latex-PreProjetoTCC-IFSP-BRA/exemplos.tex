...
\begin{figure}[!htbp]
    ...
    \legend{Fonte: Autor (ano)}	
    % Registrar o autor em referencias.bib e citar aqui usando citeonline{chave}.
...
Este é um exemplo de como usar quadros. Referência cruzada: Quadro~\ref{qua:exemplo1}
