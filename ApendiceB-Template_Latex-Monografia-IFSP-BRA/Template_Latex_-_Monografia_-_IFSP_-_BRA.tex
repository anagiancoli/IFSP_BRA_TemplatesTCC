...
% --
% Utilize a instrução \relax [...] para iniciar as frases que precisam de colchetes e reticências ou \text{[ \dots ]}. 
% Além do pacote: \usepackage{amsmath, amsfonts, amssymb} 
% importado para usar  \text{[ \dots ] }
% --
